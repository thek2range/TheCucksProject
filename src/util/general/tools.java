...
public class tools {
	...
	public static WebElement getElement ( String key ,WebDriver browser)
	{
	...
	public static WebElement pointTheElement (String identifierType, String identifierValue,WebDriver browser)
	{
		try {
			if (identifierType.equalsIgnoreCase("ID"))
			...
			if (identifierType.equalsIgnoreCase("linkText"))
				return browser.findElement(By.linkText(identifierValue));
			if (identifierType.equalsIgnoreCase("partialLinkText"))
